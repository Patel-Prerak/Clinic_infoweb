...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-gradient-to-br from-purple-50 via-indigo-50 to-white pt-20 pb-32 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-10 animate-in fade-in slide-in-from-left-6 duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link
                to="/pricing"
                className="px-10 py-5 bg-primary-600 hover:bg-primary-700 text-white rounded-2xl font-black shadow-2xl shadow-primary-600/30 transition-all duration-300 flex items-center justify-center space-x-3 hover:scale-105 active:scale-95"
              >
              ...
              <a
                ...
                className="px-10 py-5 bg-white text-slate-900 border-2 border-slate-200 rounded-2xl font-black shadow-xl hover:shadow-2xl hover:border-primary-300 transition-all duration-300 flex items-center justify-center space-x-3 hover:scale-105 active:scale-95"
              >
          ...
          <div className="hidden md:block animate-in fade-in slide-in-from-right-6 duration-1000">
            <div className="relative group">
              ...
              <div className="relative bg-white p-4 rounded-[2.5rem] overflow-hidden shadow-2xl transition-all duration-500 group-hover:scale-[1.03] border-4 border-white">
                <img
                  src="/src/assets/Screenshot 2026-01-06 003747.png"

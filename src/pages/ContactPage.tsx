    ...
    <Layout>
      <div className="min-h-screen bg-white py-12">
        ...
        <section className="bg-gradient-to-b from-white via-primary-50/20 to-white py-32 overflow-hidden relative">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary-100/30 blur-[120px] -z-10 rounded-full" />
          <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
            <h1 className="text-6xl md:text-8xl font-black text-slate-900 mb-8 tracking-tighter leading-none animate-in fade-in slide-in-from-top-10 duration-1000">
            ...
            <p className="text-2xl text-slate-600 font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-10 duration-1000">
        ...
        <section className="container mx-auto px-4 -mt-20 mb-32 relative z-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={idx} className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-10 border-2 border-white shadow-2xl shadow-slate-200/50 hover:-translate-y-2 transition-all duration-500">
                <div className="flex items-center gap-6">
                  <div className={`${stat.color} w-16 h-16 rounded-2xl flex items-center justify-center`}>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="grid lg:grid-cols-5 gap-20 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-3">
              <div className="bg-slate-50 rounded-[3rem] p-12 border-2 border-slate-100 shadow-inner group">
                <div className="mb-12">
            ...
            <div className="lg:col-span-2 space-y-10">
              {/* Email Card */}
              <div className="bg-white rounded-[2.5rem] p-10 border-2 border-slate-50 shadow-3xl hover:border-primary-100 transition-all duration-500 group">
                <div className="flex gap-8 items-start">
                  <div className="bg-primary-600 w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-xl group-hover:rotate-12 transition-transform">
              ...
              {/* Phone Card */}
              <div className="bg-white rounded-[2.5rem] p-10 border-2 border-slate-50 shadow-3xl hover:border-indigo-100 transition-all duration-500 group">
                <div className="flex gap-8 items-start">
                  <div className="bg-indigo-600 w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-xl group-hover:rotate-12 transition-transform">
              ...
              {/* Address Card */}
              <div className="bg-white rounded-[2.5rem] p-10 border-2 border-slate-50 shadow-3xl hover:border-purple-100 transition-all duration-500 group">
                <div className="flex gap-8 items-start">
                  <div className="bg-purple-600 w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-xl group-hover:rotate-12 transition-transform">
